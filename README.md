# Name<br>＜ Gjden--ジジデン ＞
〜迷える同僚<b>"おジジ社員"</b>を<b>G</b>ood<b>J</b>obに導く伝票アプリ〜<br>
...
![予約確認ボタン](予約確認.gif)<br>
<br>
<b>【予約可能な時間を細かく設定】</b><br>
既存の予約と日時・会場が重複するものは登録できないようにしています。<br>
また工夫点として、会場の片付け・セッティングの時間を考慮し、既存の予約の終了時間から1時間後から予約を登録できるようバリデーションを工夫しています。<br>
![予約重複](予約重複エラーの解説.jpeg)<br>
<br>
...
<br>
# ＜ Issue--課題＞
<b>-予約一覧をガントチャートのような形式で見やすく表現</b><br>
  現状、日毎のページの予約一覧は予約が入らないと表示されません。よって、<b>”予約可能な会場”</b>が一眼で確認することができません。<br>
  その為に、ガントチャートのようなグラフ形式で表現できないかと考えています。<br>
<br>
<b>-シフト表の導入</b><br>
  予約可能かどうか判断する際、会場の空き状況だけでなく社員のシフト状況がとても重要だと考えます。シフトの確認・管理も同時にできるアプリにしたいと考えています。<br>
<br>
<b>-顧客リストの導入</b><br>
